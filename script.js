    ...
    posts.forEach((element) => {
        ...
        <div class="flex justify-between *:font-bold [&>*:not (:last-child)]:opacity-45"
         ...
         <div class="flex gap-4">
            ...
            <button id="addToList" onclick="markAsRead('${element.description}', '${element.view_count}')"
...
const markAsRead = (description, view_count) => {
    ...
    const hold = document.getElementById('markAsReadCounter');
    let readCounter = parseFloat(hold.innerText);
    readCounter += 1;
    hold.innerText = readCounter;
    const div = document.createElement('div');
    div.innerHTML = `
    <div class = "flex justify-between p-2 lg:p-3
    bg-white rounded-2xl items-center gap-3">
